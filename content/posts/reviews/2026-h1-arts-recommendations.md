---
title: "2026-H1 Arts Recommendations"
date: 2026-07-16T16:45:00+02:00
aliases: ["/2026-h1-arts-recommendations"]
...
This blog post is an indirect follow-up to [a blog post I made back in December 2025](https://blog.thefrenchghosty.me/posts/reviews/2025-arts-recommendations/) about the "artistic objects" I enjoyed in 2025.
...
- IMDb: https://www.imdb.com/title/tt0106188

(TV movie)

This TV movie is an adaptation of [a short of the same name (but with "PM" added)](https://www.imdb.com/title/tt0098962/), which was by itself an adaptation of a short story.
I wasn't a fan of the short and expected to also not be a fan of this movie, but it ended up being probably one of the best things I've ever seen.
It is a TV movie, yet it is more impressive and more polished than a lot of actual "cinema movies".

The story of the movie is basically the same as [Groundhog Day (1993)](https://www.imdb.com/title/tt0107048/) (so much so that [the author of the short story tried to sue the producer of Groundhog Day](https://en.wikipedia.org/wiki/Groundhog_Day_(film)#Aftermath)), except, unlike Groundhog Day, it's actually good since they did the idea properly.
...
- IMDb: https://www.imdb.com/title/tt3672742
...
This show is technically a follow-up to [The Karate Kid (1984)](https://www.imdb.com/title/tt0087538) a movie that I'm not even sure I've watched from a franchise I never cared about. I have only watched season 1 of the show so my review is gonna be purely based on this season. I have heard that the show gets a bit worse after that (which is basically when Netflix bought it, coincidence...).

This show takes place after the movie, in current time, as if the movie happened back when they came out. They follow the "bad guy" of the movie and is failure of a life since the movie happened, trying to get back to "living" by going back to Karate.
It is dumb in some ways, but unlike a lot of dumb things, it's self-aware and doesn't take itself seriously. Even so it is derivative, what it ended up being is something really sweet and really nice.
...
- IMDb: https://www.imdb.com/name/nm1541482
- Wikipedia: https://en.wikipedia.org/wiki/Justin_Spitzer
...
He started by being a writer on "[The Office (2005)](https://www.imdb.com/title/tt0386676)" and when it finished, he moved to creating Superstore.


### Superstore (2015-2021)

- IMDb: https://www.imdb.com/title/tt4477976/

Superstore is [The Office (2005)](https://www.imdb.com/title/tt0386676), but not a mockumentary and in a supermaket.
...
The show isn't bad, per se. It has amazing characters, amazing character relationships, and, in some ways, has better ideas than [The Office (2005)](https://www.imdb.com/title/tt0386676). The problem with the show is that any time I think about it. The only thing I can think of is "what a wasted potential" It could and should have been great, it sometimes is great, but it never is fully successful and none of the plots actually develop in a way that is really satisfying.

The way it ends honestly makes the show a lot worse (then again, the way [The Office (2005)](https://www.imdb.com/title/tt0386676) ends is awful). I did read at some point (because it took me almost the whole of season 1 to get into it, I really didn't like it at first, so I wanted to know if it gets better) that the show gets worse when the romance "succeeds", and I don't necessarily disagree.
...
This is a show taking the presentation of [The Office (2005)](https://www.imdb.com/title/tt0386676) by going full-on mockumentary and focusing (mostly) on a "single small room" (with some external "views" of the world when needed)... except in a hospital, where effectively people come and go and it's always different, this benefits the show in the sense that nothing is ever stale, since it is purely character-driven and situations arise from new characters all the time.
...
- Steam: https://store.steampowered.com/app/521280/Atlantis_Pearls_of_the_Deep/

- PCGamingWiki: https://www.pcgamingwiki.com/wiki/Atlantis%3A_Pearls_of_the_Deep
...
- Official website: https://www.pifflegame.com/
- Apple Arcade: https://apps.apple.com/app/piffle/id6742088715

This game is taking the idea of [arcanoid](https://en.wikipedia.org/wiki/Arkanoid) (or any kind of brick breaker game) and making it into something far more interesting by making the "bricks" have different effect and different behavior depending on what happens (either you hit them or didn't hit them) - some will move, some will duplicates, some can only be hit on one side...
...
- Official website: https://www-staging.dots.co/garden-tails/ (staging website? Seems to be the only one working...)
- Apple Arcade: https://apps.apple.com/app/garden-tails-match-and-grow/id1613174241
...
I guess I can recommend the [Starbound soundtrack](https://store.steampowered.com/app/268090/Starbound__Soundtrack/), but I don't have much to say about it.
